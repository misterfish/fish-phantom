...
var system, mainJs, preludeLs, ref$, map, each, join, fishLib, log, info, bullet, iwarn, warn, error, array, isArray, sprintf, yellow, magenta, brightRed, green, isIntegerPositive, our, out$ = typeof exports != 'undefined' && exports || this, slice$ = [].slice, toString$ = {}.toString;
...
ref$ = fishLib = require('fish-lib'), log = ref$.log, info = ref$.info, bullet = ref$.bullet, iwarn = ref$.iwarn, warn = ref$.warn, error = ref$.error, array = ref$.array, isArray = ref$.isArray, sprintf = ref$.sprintf, yellow = ref$.yellow, magenta = ref$.magenta, brightRed = ref$.brightRed, green = ref$.green, isIntegerPositive = ref$.isIntegerPositive;
our = {
...
function conditionWait(sandboxFunction, arg$){
  ...
  if (!isIntegerPositive(checkInterval)) {
